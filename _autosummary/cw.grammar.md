...
[`cw.base.ArghHelpFormatter`](cw.base.md#cw.base.ArghHelpFormatter) renders as `repr(default)`.
...
[`argparse_dest`](#cw.grammar.ArgSpec.argparse_dest) names it and [`cw.cli`](cw.cli.md#module-cw.cli) renames it back on the way into
...
#### codec *: [Codec](cw.base.md#cw.base.Codec) | [None](https://docs.python.org/3/builtins/constants.html#None)* *= None*

...
[`cw.commands.import_object()`](cw.commands.md#cw.commands.import_object)). The colon form is the unambiguous one – it
...
| [`base`](cw.base.md#module-cw.base)             | The small vocabulary cw's other modules share: sentinels, errors, and help rendering.   |
|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| [`cli`](cw.cli.md#module-cw.cli)               | The argparse surface: building a parser, and running one.                               |
| [`commands`](cw.commands.md#module-cw.commands)     | Turning an object into the `{name: callable}` tree a parser is built from.              |
| [`compat`](cw.compat.md#module-cw.compat)         | Transitional argh shim: a one-line import change retires a repo.                        |
| [`convention`](cw.convention.md#module-cw.convention) | What cw's defaults ARE, as one frozen value per context.                                |
| [`egress`](cw.egress.md#module-cw.egress)         | Result to stdout: how a function's return value becomes lines and an exit code.         |
| [`grammar`](cw.grammar.md#module-cw.grammar)       | How a Python signature becomes command-line arguments.                                  |
| [`ingress`](cw.ingress.md#module-cw.ingress)       | Namespace to call: the lines that honour `/`, `*args`, `*` and `**kwargs`.              |
| [`resolution`](cw.resolution.md#module-cw.resolution) | Function resolution utilities for CLI parameterization.                                 |
| [`testing`](cw.testing.md#module-cw.testing)       | Record a CLI's behaviour before a migration and assert it after.                        |

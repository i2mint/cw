...
[`cw.grammar.specs_for_function()`](cw.grammar.html.md#cw.grammar.specs_for_function), and lives there rather than here because it is the
only place that knows what a [`cw.grammar.ArgSpec`](cw.grammar.html.md#cw.grammar.ArgSpec) is. There is no second copy.
...
already names. [`cw.mk_parser()`](cw.html.md#cw.mk_parser) defaults it to [`cw.ArghHelpFormatter`](cw.html.md#cw.ArghHelpFormatter) and passes
